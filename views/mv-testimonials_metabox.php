<table class="form-table mv-testimonials-metabox"> 
    <tr>
        <th>
            <label for="mv_testimonials_occupation">
                <?php esc_html_e('User occupation', 'mv-testimonials'); ?>
            </label>
        </th>
        <td>
            <input 
    ...
    <tr>
        <th>
            <label for="mv_testimonials_company">
                <?php esc_html_e('User company', 'mv-testimonials'); ?>
            </label>
        </th>
        <td>
            <input 
    ...
    <tr>
        <th>
            <label for="mv_testimonials_user_url">
                <?php esc_html_e('User URL', 'mv-testimonials'); ?>
            </label>
        </th>
        <td>
            <input 
